...
def test_offline_design_policy_planner_and_dry_run_do_not_embed_cisco_write_cli():
    dangerous_fragments = {
        "configure terminal",
    ...
    assert not violations, f"Offline design/policy/planner/dry-run layer embedded device write CLI: {violations}"
